...
And('I design new custom fields', () => {
  ...
  cy.get(':nth-child(3) > .field-body > .control > .input').clear().type('Yes')
  cy.get(':nth-child(4) > .field-body > .control > .input').clear().type('No')
  cy.get('[style="width: 35px;"]').click()
  cy.get(':nth-child(5) > .field-body > .control > .input').clear().type('I dont know')
