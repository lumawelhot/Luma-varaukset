...
When('valid information is entered', () => {
  ...
  cy.get(':nth-child(2) > .control > .ant-picker > .ant-picker-input > input').click()
  ...
  cy.get('body > div:nth-child(4) > div > div > div > div > div.ant-picker-footer > ul > li > button').click()
  cy.get(':nth-child(3) > .control > .ant-picker > .ant-picker-input > input').click()
  cy.get('.ant-picker-content').within(() => {
    cy.get('ul .ant-picker-time-panel-cell').contains('09').click({ force: true })
    cy.get('ul:last-child .ant-picker-time-panel-cell').contains('45').click({ force: true })
  })
