...
describe('As an employee I can', () => {
  ...
  it('create a new event', () => {
    ...
    cy.get(':nth-child(9) > :nth-child(2) > .chakra-checkbox__control').click()
    ...
    cy.get(':nth-child(14) > :nth-child(3) > .chakra-checkbox__control').click()
    cy.get(':nth-child(19) > [style="width: 100%; margin-right: 15px;"] > :nth-child(1) > .react-datepicker-wrapper > .react-datepicker__input-container > .sc-jqUVSM')
      .click().clear().type(format(date, 'dd.MM.yyyy'))
    cy.get('[style="margin-top: 40px;"] > .chakra-button').click()
    cy.get(':nth-child(22) > :nth-child(1) > :nth-child(1) > .react-datepicker-wrapper > .react-datepicker__input-container > .sc-jqUVSM')
